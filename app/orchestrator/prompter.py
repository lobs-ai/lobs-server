...
class Prompter:
    ...
    def build_task_prompt(
        ...
        # Escalation instructions — only for local/small tier models
        model_tier = (item.get("model_tier") or "").lower()
        if model_tier in ("micro", "small"):
            escalation_block = (
                "\n## Escalation Policy\n\n"
                "You are running on a local model. If this task is beyond your capability "
